...
class FCFSApp(App):
    def build(self):
        ...
        calculate_button = Button(text="Calculate FCFS", size_hint=(1, None), height=dp(40))
    ...
    def generate_input_fields(self, instance):
        ...
        for i in range(num_processes):
            ...
            process_input = TextInput(hint_text=f"Enter burst time for process {i + 1}", size_hint_y=None, height=dp(40), multiline=False)
